...
#         #here we want to update our room so first we have
#         #to check wheather our givren data is valid or not
#         #if not valid then we cant update then in out room right?
...
#            #check if host is owner of the room
